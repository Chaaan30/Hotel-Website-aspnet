<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.Master" AutoEventWireup="true" CodeBehind="AfterSignIn_HotelAreas.aspx.cs" Inherits="IT114L_B54_Group_5.WebForm3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
    ...
    <div class="header2">
            ...
            <div>
                <center>
                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass="auto-style19" PostBackUrl="~/RoomSingle.aspx">Click Here to Reserve!</asp:LinkButton>
                </center>
            </div>
            <div>
                &nbsp
