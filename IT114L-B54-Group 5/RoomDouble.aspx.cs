...
namespace IT114L_B54_Group_5
{
    public partial class WebForm10 : System.Web.UI.Page
    {
        ...
        protected void cancelDouble_Click(object sender, EventArgs e)
        {
            YesCancel_double.Visible = true;
            NoCancel_double.Visible = true;
            cancelDoubleConfirmation.Visible = true;
        }
        ...
        protected void YesCancel_Click(object sender, EventArgs e)
        {
            ...
            YesCancel_double.Visible = false;
            NoCancel_double.Visible = false;
            cancelDoubleConfirmation.Visible = false;
        ...
        protected void ReserveDouble_Click(object sender, EventArgs e)
        {
            OleDbConnection connection = new OleDbConnection("Provider = Microsoft.Ace.OleDb.12.0;Data Source=" + Server.MapPath("~/App_Data/DBMP5.accdb"));
            connection.Open();

            // Check if the room is available
            string checkRoomStatus = "SELECT RoomStatus FROM HotelRooms WHERE RoomID = '" + DoubleRID.Text + "'";
            ...
            // Add reservation
            string insertReservation = "Insert into ReservationTBL(ClientUsername, RoomID, CheckIn, CheckOut, TotalAmount) values('" + TextBox2.Text + "' , '" + DoubleRID.Text + "' , '" + check_in.Text + "' , '" + check_out.Text + "' , '" + total_box.Text + "');";
            OleDbCommand cmdInsertReservation = new OleDbCommand(insertReservation, connection);
            cmdInsertReservation.ExecuteNonQuery();

            // Update reservation status
            string updateReservationStatus = "Update ReservationTBL set ReservationStatus = 1 WHERE RoomID = '" + DoubleRID.Text + "'";
            ...
            // Update room status
            string updateRoomStatus = "Update HotelRooms set RoomStatus = 1 WHERE RoomID = '" + DoubleRID.Text + "'";
